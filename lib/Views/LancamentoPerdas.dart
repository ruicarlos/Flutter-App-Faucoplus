...
class LancamentoPerdasGeral extends StatefulWidget {
  LancamentoPerdasGeral({Key? key}) : super(key: key);

  @override
  _LancamentoPerdasGeralState createState() => _LancamentoPerdasGeralState();
}

class _LancamentoPerdasGeralState extends State<LancamentoPerdasGeral> {
  TextEditingController _textFieldController = TextEditingController();

  var _mapTipTroca = ['DESCARTE', 'TROCA'];
  var _tipoPerda;
  ...
  Future<bool> _onbackPressed() async{
    return (await  showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Sair do Lançamento de Perdas?'),
        actions: <Widget>[
          FlatButton(
